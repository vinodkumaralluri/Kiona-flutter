...
class AssignedTaskSection extends StatelessWidget {
  const AssignedTaskSection({super.key});
          ...
          children: [
            homeState.taskList == null
                ...
                : Padding(
                    ...
                    child: homeState.assignedTaskList.isEmpty
                        ? Padding(
                        ...
                        : Column(
                            children: [
                              ...
                              ...List.generate(
                                homeState.assignedTaskList.length,
                                (index) {
                                  final data =
                                      homeState.assignedTaskList[index];
                                  return InkWell(
                                    onTap: () {
